...
function StepProductos({children}){
              ...
              <Form.Group className="mb-3" controlId="formNameProduct">
                <InputGroup size="xs" className="shadow-sm border rounded overflow-hidden pagination-input-group">
                  ...
                  <Form.Control
                    ...
                    name="product_name"
                    value={currentItem.product_name || undefined}
                    onChange={handleChange}
                    disabled={isDisabledField("product_name", true)}
                    />
                    ...
                    style={{
                      ...
                      cursor: editableFields["product_name"] ? 'default' : 'pointer'
                    }}
                    onClick={() => handleEnableEdit("product_name")}
                  >
                    <i className={`bi ${editableFields["product_name"] ? "bi-check text-primary" : "bi-pencil"}`}
                      style={{ opacity: '.8' }}>
                    </i>
                  </InputGroup.Text>
                    )}
